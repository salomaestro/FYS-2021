This is a README for Candidate 25's solution to the tasks given in Portofolio assignment 1.

to run the code, firstly you will need to have the modules numpy, matplotlib and os installed on your computer. You can use:
